# Black Hat C++ [![Stars](https://img.shields.io/github/stars/zet235/black-hat-cpp?style=social)](https://github.com/zet235/black-hat-cpp/stargazers) [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

> A curated collection of C++ libraries, tools, and resources for security research, binary analysis, and low-level systems programming on Windows and Linux.
...
- [Security](#security)
  ...
  - [Loader](#loader)
  - [Anti-Analysis & Evasion](#anti-analysis--evasion)
  - [Obfuscation](#obfuscation)
  - [Windows API & Syscalls](#windows-api--syscalls)
  - [Hook](#hook)
...
- [Google C++ Style Guide (繁體中文)](https://tw-google-styleguide.readthedocs.io/en/latest/google-cpp-styleguide/contents.html)
...
Contributions are welcome! Please open a pull request or issue to suggest new resources.

## Disclaimer

This repository is intended for **educational purposes and authorized security research only**. The tools and techniques listed here should only be used in legal and ethical contexts such as penetration testing with proper authorization, CTF competitions, and academic research. Misuse of these resources may violate laws and regulations.
